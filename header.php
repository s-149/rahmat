...
<head>
  ...
  <title>SISTEM INFORMASI DATA PENDUDUK</title>
  ...
  <link rel="icon" href="gambar/download.png" type="image/x-icon">
  <!-- select -->
...
<div class="wrapper">
  <header class="main-header">
    <a href="beranda.php" class="logo">
      ...
      <span class="logo-lg"><b>DESA CILANGKAP</span>
    </a>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pekerjaan_add.php"><i class="fa fa-wrench"></i> Data Pekerjaan</a></li>
             <li><a href="lurah_add.php"><i class="fa fa-wrench"></i> Data Kepala Desa</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
       <div class="anic">
        ...
        <h4>SISTEM INFORMASI DATA KEPENDUDUKAN DESA CILANGKAP</h4>
