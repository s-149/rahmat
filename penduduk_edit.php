        ...
        <div class="col-md-6">
          ...
          if (isset($_POST["btnsimpan"])){
                  ...
                  $tahun=$_POST['tahun_dicari'];
                    $edit = mysqli_query($konek,"UPDATE  tbl_warga SET nik='$txtnik',nama='$txtnama',kd_lurah='$cblurah',kd_pekerjaan='$cbpekerjaan',kd_pendidikan='$cbpendidikan',kd_agama='$cbagama',tgl_lahir='$txttanggal',jenis_kelamin='$cbjeniskelamin',alamat='$txtalamat',kecamatan='$txtkecamatan',kabupaten='$txtkabupaten',provinsi='$txtprovinsi',negara='$txtnegara',status_kawin='$cbstatus',tempat_lahir='$txttempatlahir',jenis='$cbjenispenduduk',tahun='$tahun' WHERE kode='$setvalidlayanancodingMjIyM'");
            if ($edit)
            {
              ?>
