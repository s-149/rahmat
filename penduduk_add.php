       ...
       <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label>NIK *</label>
                  <input type="text" maxlength="16" class="form-control" name="txtnik" placeholder="Input NIK" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" autocomplete="off" />
                </div>


                   <div class="form-group">
                  <label>Nama *</label>
                  <input type="text" class="form-control" name="txtnama" placeholder="Input" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')"autocomplete="off" />
                </div>
                   <div class="form-group">
                  <label>Tempat Lahir *</label>
                  <input type="text" class="form-control" name="txttempatlahir" placeholder="Input" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')"autocomplete="off" />
                </div>


                   <div class="form-group">
                  <label>Tgl Lahir *</label>
                  <input type="date" class="form-control" id="date" name="txttanggal" placeholder="Input" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')"autocomplete="off" />
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tahun_dicari" value="<?= date('Y'); ?>" readonly>
                </div>
          ...
          if (isset($_POST["btnsimpan"])){
                  ...
                  $tahun=$_POST['tahun_dicari'];

                      $simpan = mysqli_query($konek,"INSERT INTO tbl_warga (kd_lurah,kd_pekerjaan,kd_pendidikan,kd_agama,nik,nama,tgl_lahir,jenis_kelamin,alamat,kecamatan,kabupaten,provinsi,negara,status_kawin,tempat_lahir,jenis,tahun) VALUES ('$cblurah','$cbpekerjaan','$cbpendidikan','$cbagama','$txtnik','$txtnama','$txttanggal','$cbjeniskelamin','$txtalamat','$txtkecamatan','$txtkabupaten','$txtprovinsi','$txtnegara','$cbstatus','$txttempatlahir','$cbjenispenduduk',$tahun)");
                      if ($simpan){
                        ?>
